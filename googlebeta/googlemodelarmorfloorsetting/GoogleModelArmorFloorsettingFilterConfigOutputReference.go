...
import (
	...
	"github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16/googlemodelarmorfloorsetting/internal"
...
func NewGoogleModelArmorFloorsettingFilterConfigOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) GoogleModelArmorFloorsettingFilterConfigOutputReference {
	...
	_jsii_.Create(
		"@cdktf/provider-google-beta.googleModelArmorFloorsetting.GoogleModelArmorFloorsettingFilterConfigOutputReference",
