...
package googlebigqueryrowaccesspolicy
...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "filterPredicate", GoGetter: "FilterPredicate"},
			_jsii_.MemberProperty{JsiiProperty: "filterPredicateInput", GoGetter: "FilterPredicateInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "grantees", GoGetter: "Grantees"},
			_jsii_.MemberProperty{JsiiProperty: "granteesInput", GoGetter: "GranteesInput"},
