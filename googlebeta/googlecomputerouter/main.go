...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putMd5AuthenticationKeys", GoMethod: "PutMd5AuthenticationKeys"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetMd5AuthenticationKeys", GoMethod: "ResetMd5AuthenticationKeys"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "identifierRangeInput", GoGetter: "IdentifierRangeInput"},
			_jsii_.MemberProperty{JsiiProperty: "internalValue", GoGetter: "InternalValue"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetIdentifierRange", GoMethod: "ResetIdentifierRange"},
