...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "generatedUriPattern", GoGetter: "GeneratedUriPattern"},
			...
			_jsii_.MemberProperty{JsiiProperty: "indexingStatus", GoGetter: "IndexingStatus"},
			...
			_jsii_.MemberProperty{JsiiProperty: "providedUriPattern", GoGetter: "ProvidedUriPattern"},
			_jsii_.MemberProperty{JsiiProperty: "providedUriPatternInput", GoGetter: "ProvidedUriPatternInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "rootDomainUri", GoGetter: "RootDomainUri"},
			_jsii_.MemberProperty{JsiiProperty: "siteVerificationInfo", GoGetter: "SiteVerificationInfo"},
			_jsii_.MemberMethod{JsiiMethod: "synthesizeAttributes", GoMethod: "SynthesizeAttributes"},
			_jsii_.MemberMethod{JsiiMethod: "synthesizeHclAttributes", GoMethod: "SynthesizeHclAttributes"},
			_jsii_.MemberProperty{JsiiProperty: "targetSiteId", GoGetter: "TargetSiteId"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "quotaFailure", GoGetter: "QuotaFailure"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "siteVerificationState", GoGetter: "SiteVerificationState"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
