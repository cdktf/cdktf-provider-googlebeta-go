...
import (
	...
	"github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6/datagooglefirebasewebapp/internal"
...
func (j *jsiiProxy_DataGoogleFirebaseWebApp) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_DataGoogleFirebaseWebApp)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
