...
import (
	...
	"github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14/googleredisclusterusercreatedconnections/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.27.0/docs/resources/google_redis_cluster_user_created_connections google_redis_cluster_user_created_connections}.
...
func (j *jsiiProxy_GoogleRedisClusterUserCreatedConnections) ClusterEndpoints() GoogleRedisClusterUserCreatedConnectionsClusterEndpointsList {
	var returns GoogleRedisClusterUserCreatedConnectionsClusterEndpointsList
	_jsii_.Get(
		j,
		"clusterEndpoints",
		&returns,
...
func (j *jsiiProxy_GoogleRedisClusterUserCreatedConnections) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_GoogleRedisClusterUserCreatedConnections) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GoogleRedisClusterUserCreatedConnections) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_GoogleRedisClusterUserCreatedConnections) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_GoogleRedisClusterUserCreatedConnections) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_GoogleRedisClusterUserCreatedConnections) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_GoogleRedisClusterUserCreatedConnections) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_GoogleRedisClusterUserCreatedConnections) Node() constructs.Node {
...
func (j *jsiiProxy_GoogleRedisClusterUserCreatedConnections) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_GoogleRedisClusterUserCreatedConnections) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_GoogleRedisClusterUserCreatedConnections) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_GoogleRedisClusterUserCreatedConnections) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_GoogleRedisClusterUserCreatedConnections) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleRedisClusterUserCreatedConnections) Timeouts() GoogleRedisClusterUserCreatedConnectionsTimeoutsOutputReference {
	var returns GoogleRedisClusterUserCreatedConnectionsTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.27.0/docs/resources/google_redis_cluster_user_created_connections google_redis_cluster_user_created_connections} Resource.
func NewGoogleRedisClusterUserCreatedConnections(scope constructs.Construct, id *string, config *GoogleRedisClusterUserCreatedConnectionsConfig) GoogleRedisClusterUserCreatedConnections {
	...
	if err := validateNewGoogleRedisClusterUserCreatedConnectionsParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func GoogleRedisClusterUserCreatedConnections_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google-beta.googleRedisClusterUserCreatedConnections.GoogleRedisClusterUserCreatedConnections",
...
func (g *jsiiProxy_GoogleRedisClusterUserCreatedConnections) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleRedisClusterUserCreatedConnections) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (g *jsiiProxy_GoogleRedisClusterUserCreatedConnections) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (g *jsiiProxy_GoogleRedisClusterUserCreatedConnections) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (g *jsiiProxy_GoogleRedisClusterUserCreatedConnections) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (g *jsiiProxy_GoogleRedisClusterUserCreatedConnections) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (g *jsiiProxy_GoogleRedisClusterUserCreatedConnections) GetStringAttribute(terraformAttribute *string) *string {
...
func (g *jsiiProxy_GoogleRedisClusterUserCreatedConnections) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (g *jsiiProxy_GoogleRedisClusterUserCreatedConnections) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleRedisClusterUserCreatedConnections) MoveToId(id *string) {
...
func (g *jsiiProxy_GoogleRedisClusterUserCreatedConnections) OverrideLogicalId(newLogicalId *string) {
...
func (g *jsiiProxy_GoogleRedisClusterUserCreatedConnections) PutTimeouts(value *GoogleRedisClusterUserCreatedConnectionsTimeouts) {
...
func (g *jsiiProxy_GoogleRedisClusterUserCreatedConnections) ResetClusterEndpoints() {
	_jsii_.InvokeVoid(
		g,
		"resetClusterEndpoints",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleRedisClusterUserCreatedConnections) ResetId() {
	_jsii_.InvokeVoid(
		g,
		"resetId",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleRedisClusterUserCreatedConnections) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		g,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleRedisClusterUserCreatedConnections) ResetProject() {
	_jsii_.InvokeVoid(
		g,
		"resetProject",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleRedisClusterUserCreatedConnections) ResetTimeouts() {
	_jsii_.InvokeVoid(
		g,
		"resetTimeouts",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleRedisClusterUserCreatedConnections) ToString() *string {
	var returns *string
