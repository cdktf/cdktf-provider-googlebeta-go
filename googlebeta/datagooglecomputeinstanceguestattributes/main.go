...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "queryPath", GoGetter: "QueryPath"},
			_jsii_.MemberProperty{JsiiProperty: "queryPathInput", GoGetter: "QueryPathInput"},
			_jsii_.MemberProperty{JsiiProperty: "queryValue", GoGetter: "QueryValue"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetQueryPath", GoMethod: "ResetQueryPath"},
			_jsii_.MemberMethod{JsiiMethod: "resetRegion", GoMethod: "ResetRegion"},
			_jsii_.MemberMethod{JsiiMethod: "resetVariableKey", GoMethod: "ResetVariableKey"},
