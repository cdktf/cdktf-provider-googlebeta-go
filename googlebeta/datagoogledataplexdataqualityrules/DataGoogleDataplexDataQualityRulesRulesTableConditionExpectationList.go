...
import (
	...
	"github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16/datagoogledataplexdataqualityrules/internal"
...
func (j *jsiiProxy_DataGoogleDataplexDataQualityRulesRulesTableConditionExpectationList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleDataplexDataQualityRulesRulesTableConditionExpectationList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleDataplexDataQualityRulesRulesTableConditionExpectationList {
	_init_.Initialize()
...
func NewDataGoogleDataplexDataQualityRulesRulesTableConditionExpectationList_Override(d DataGoogleDataplexDataQualityRulesRulesTableConditionExpectationList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleDataplexDataQualityRulesRulesTableConditionExpectationList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleDataplexDataQualityRulesRulesTableConditionExpectationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleDataplexDataQualityRulesRulesTableConditionExpectationList) Resolve(_context cdktf.IResolveContext) interface{} {
