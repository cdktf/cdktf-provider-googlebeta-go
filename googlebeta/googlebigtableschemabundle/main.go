...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "schemaBundleId", GoGetter: "SchemaBundleId"},
			_jsii_.MemberProperty{JsiiProperty: "schemaBundleIdInput", GoGetter: "SchemaBundleIdInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "protoDescriptors", GoGetter: "ProtoDescriptors"},
			_jsii_.MemberProperty{JsiiProperty: "protoDescriptorsInput", GoGetter: "ProtoDescriptorsInput"},
