...
func (j *jsiiProxy_DataGoogleBillingAccount) CurrencyCode() *string {
	var returns *string
	_jsii_.Get(
		j,
		"currencyCode",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.2/docs/data-sources/google_billing_account google_billing_account} Data Source.
