...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "lookupProjects", GoGetter: "LookupProjects"},
			_jsii_.MemberProperty{JsiiProperty: "lookupProjectsInput", GoGetter: "LookupProjectsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetLookupProjects", GoMethod: "ResetLookupProjects"},
