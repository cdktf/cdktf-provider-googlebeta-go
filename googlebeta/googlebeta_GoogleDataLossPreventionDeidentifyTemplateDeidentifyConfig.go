...
type GoogleDataLossPreventionDeidentifyTemplateDeidentifyConfig struct {
	...
	InfoTypeTransformations *GoogleDataLossPreventionDeidentifyTemplateDeidentifyConfigInfoTypeTransformations `field:"required" json:"infoTypeTransformations" yaml:"infoTypeTransformations"`
}
