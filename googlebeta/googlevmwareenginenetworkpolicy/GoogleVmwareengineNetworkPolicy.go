...
import (
	...
	"github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16/googlevmwareenginenetworkpolicy/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.47.0/docs/resources/google_vmwareengine_network_policy google_vmwareengine_network_policy}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.47.0/docs/resources/google_vmwareengine_network_policy google_vmwareengine_network_policy} Resource.
...
func GoogleVmwareengineNetworkPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleVmwareengineNetworkPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleVmwareengineNetworkPolicy) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleVmwareengineNetworkPolicy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleVmwareengineNetworkPolicy) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleVmwareengineNetworkPolicy) MoveToId(id *string) {
