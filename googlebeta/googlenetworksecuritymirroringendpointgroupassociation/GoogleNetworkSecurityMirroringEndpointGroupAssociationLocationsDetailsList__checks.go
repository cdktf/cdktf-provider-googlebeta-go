...
func (g *jsiiProxy_GoogleNetworkSecurityMirroringEndpointGroupAssociationLocationsDetailsList) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
