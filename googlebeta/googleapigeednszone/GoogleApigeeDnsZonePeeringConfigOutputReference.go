...
import (
	...
	"github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googleapigeednszone/internal"
...
func (j *jsiiProxy_GoogleApigeeDnsZonePeeringConfigOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleApigeeDnsZonePeeringConfigOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) GoogleApigeeDnsZonePeeringConfigOutputReference {
	_init_.Initialize()
...
func NewGoogleApigeeDnsZonePeeringConfigOutputReference_Override(g GoogleApigeeDnsZonePeeringConfigOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleApigeeDnsZonePeeringConfigOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleApigeeDnsZonePeeringConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleApigeeDnsZonePeeringConfigOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (g *jsiiProxy_GoogleApigeeDnsZonePeeringConfigOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleApigeeDnsZonePeeringConfigOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
