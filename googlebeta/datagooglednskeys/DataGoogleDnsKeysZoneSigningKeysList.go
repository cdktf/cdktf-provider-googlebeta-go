...
func (j *jsiiProxy_DataGoogleDnsKeysZoneSigningKeysList) InternalValue() interface{} {
...
func (j *jsiiProxy_DataGoogleDnsKeysZoneSigningKeysList)SetInternalValue(val interface{}) {
