...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "connectedDeploymentGroup", GoGetter: "ConnectedDeploymentGroup"},
			...
			_jsii_.MemberProperty{JsiiProperty: "interceptEndpointGroupId", GoGetter: "InterceptEndpointGroupId"},
			_jsii_.MemberProperty{JsiiProperty: "interceptEndpointGroupIdInput", GoGetter: "InterceptEndpointGroupIdInput"},
