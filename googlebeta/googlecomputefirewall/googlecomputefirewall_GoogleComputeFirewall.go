...
import (
	...
	"github.com/hashicorp/cdktf-provider-googlebeta-go/googlebeta/v3/googlecomputefirewall/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://www.terraform.io/docs/providers/google-beta/r/google_compute_firewall google_compute_firewall}.
...
func (j *jsiiProxy_GoogleComputeFirewall) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://www.terraform.io/docs/providers/google-beta/r/google_compute_firewall google_compute_firewall} Resource.
...
func (j *jsiiProxy_GoogleComputeFirewall)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
