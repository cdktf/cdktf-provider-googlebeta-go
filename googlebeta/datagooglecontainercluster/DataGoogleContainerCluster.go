...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.18.0/docs/data-sources/google_container_cluster google_container_cluster}.
...
func (j *jsiiProxy_DataGoogleContainerCluster) ClusterTelemetry() DataGoogleContainerClusterClusterTelemetryList {
	var returns DataGoogleContainerClusterClusterTelemetryList
	_jsii_.Get(
		j,
		"clusterTelemetry",
		&returns,
...
func (j *jsiiProxy_DataGoogleContainerCluster) Fleet() DataGoogleContainerClusterFleetList {
	var returns DataGoogleContainerClusterFleetList
	_jsii_.Get(
		j,
		"fleet",
		&returns,
...
func (j *jsiiProxy_DataGoogleContainerCluster) IdentityServiceConfig() DataGoogleContainerClusterIdentityServiceConfigList {
	var returns DataGoogleContainerClusterIdentityServiceConfigList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleContainerCluster) NodePoolAutoConfig() DataGoogleContainerClusterNodePoolAutoConfigList {
	var returns DataGoogleContainerClusterNodePoolAutoConfigList
	_jsii_.Get(
		j,
		"nodePoolAutoConfig",
		&returns,
...
func (j *jsiiProxy_DataGoogleContainerCluster) TpuConfig() DataGoogleContainerClusterTpuConfigList {
	var returns DataGoogleContainerClusterTpuConfigList
	_jsii_.Get(
		j,
		"tpuConfig",
		&returns,
...
func (j *jsiiProxy_DataGoogleContainerCluster) WorkloadAltsConfig() DataGoogleContainerClusterWorkloadAltsConfigList {
	var returns DataGoogleContainerClusterWorkloadAltsConfigList
	_jsii_.Get(
		j,
		"workloadAltsConfig",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.18.0/docs/data-sources/google_container_cluster google_container_cluster} Data Source.
