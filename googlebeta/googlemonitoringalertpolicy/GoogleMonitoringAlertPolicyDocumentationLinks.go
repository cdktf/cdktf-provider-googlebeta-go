...
type GoogleMonitoringAlertPolicyDocumentationLinks struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.11.1/docs/resources/google_monitoring_alert_policy#url GoogleMonitoringAlertPolicy#url}
