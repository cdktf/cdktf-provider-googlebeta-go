...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.2/docs/data-sources/google_compute_instance_group_manager google_compute_instance_group_manager}.
...
func (j *jsiiProxy_DataGoogleComputeInstanceGroupManager) ResourcePolicies() DataGoogleComputeInstanceGroupManagerResourcePoliciesList {
	var returns DataGoogleComputeInstanceGroupManagerResourcePoliciesList
	_jsii_.Get(
		j,
		"resourcePolicies",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.2/docs/data-sources/google_compute_instance_group_manager google_compute_instance_group_manager} Data Source.
