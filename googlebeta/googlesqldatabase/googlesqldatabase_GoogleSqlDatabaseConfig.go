...
type GoogleSqlDatabaseConfig struct {
	...
	// values are: "ABANDON".
	//
	// Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/google-beta/r/google_sql_database#deletion_policy GoogleSqlDatabase#deletion_policy}
