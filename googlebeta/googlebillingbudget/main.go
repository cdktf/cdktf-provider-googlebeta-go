...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "ownershipScope", GoGetter: "OwnershipScope"},
			_jsii_.MemberProperty{JsiiProperty: "ownershipScopeInput", GoGetter: "OwnershipScopeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetOwnershipScope", GoMethod: "ResetOwnershipScope"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "enableProjectLevelRecipients", GoGetter: "EnableProjectLevelRecipients"},
			_jsii_.MemberProperty{JsiiProperty: "enableProjectLevelRecipientsInput", GoGetter: "EnableProjectLevelRecipientsInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEnableProjectLevelRecipients", GoMethod: "ResetEnableProjectLevelRecipients"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetResourceAncestors", GoMethod: "ResetResourceAncestors"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "resourceAncestors", GoGetter: "ResourceAncestors"},
			_jsii_.MemberProperty{JsiiProperty: "resourceAncestorsInput", GoGetter: "ResourceAncestorsInput"},
