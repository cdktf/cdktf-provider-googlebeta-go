...
func (j *jsiiProxy_GoogleBigqueryDatasetAccessA) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func NewGoogleBigqueryDatasetAccessA(scope constructs.Construct, id *string, config *GoogleBigqueryDatasetAccessAConfig) GoogleBigqueryDatasetAccessA {
	...
	_jsii_.Create(
		"@cdktf/provider-google-beta.GoogleBigqueryDatasetAccessA",
...
func (j *jsiiProxy_GoogleBigqueryDatasetAccessA)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
