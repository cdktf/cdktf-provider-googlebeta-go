...
func (g *jsiiProxy_GoogleNetappVolumeMountOptionsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (g *jsiiProxy_GoogleNetappVolumeMountOptionsList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_GoogleNetappVolumeMountOptionsList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_GoogleNetappVolumeMountOptionsList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
