...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google-beta.dataGoogleDataprocMetastoreTableIamPolicy.DataGoogleDataprocMetastoreTableIamPolicy",
		reflect.TypeOf((*DataGoogleDataprocMetastoreTableIamPolicy)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google-beta.dataGoogleDataprocMetastoreTableIamPolicy.DataGoogleDataprocMetastoreTableIamPolicyConfig",
		reflect.TypeOf((*DataGoogleDataprocMetastoreTableIamPolicyConfig)(nil)).Elem(),
	)
}
