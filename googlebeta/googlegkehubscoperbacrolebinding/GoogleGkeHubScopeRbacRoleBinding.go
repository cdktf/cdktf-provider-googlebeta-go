...
import (
	...
	"github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14/googlegkehubscoperbacrolebinding/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.25.0/docs/resources/google_gke_hub_scope_rbac_role_binding google_gke_hub_scope_rbac_role_binding}.
type GoogleGkeHubScopeRbacRoleBinding interface {
	...
	SetScopeRbacRoleBindingId(val *string)
	...
	PutRole(value *GoogleGkeHubScopeRbacRoleBindingRole)
...
func (j *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) CreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createTime",
...
func (j *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) DeleteTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deleteTime",
...
func (j *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) Group() *string {
	var returns *string
	_jsii_.Get(
		j,
		"group",
...
func (j *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) GroupInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"groupInput",
...
func (j *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) Node() constructs.Node {
...
func (j *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) Role() GoogleGkeHubScopeRbacRoleBindingRoleOutputReference {
	var returns GoogleGkeHubScopeRbacRoleBindingRoleOutputReference
	_jsii_.Get(
		j,
		"role",
		&returns,
...
func (j *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) RoleInput() *GoogleGkeHubScopeRbacRoleBindingRole {
...
func (j *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) ScopeId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"scopeId",
...
func (j *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) ScopeIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"scopeIdInput",
...
func (j *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) ScopeRbacRoleBindingId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) ScopeRbacRoleBindingIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"scopeRbacRoleBindingIdInput",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) State() GoogleGkeHubScopeRbacRoleBindingStateList {
	var returns GoogleGkeHubScopeRbacRoleBindingStateList
	_jsii_.Get(
		j,
		"state",
		&returns,
...
func (j *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) Timeouts() GoogleGkeHubScopeRbacRoleBindingTimeoutsOutputReference {
	var returns GoogleGkeHubScopeRbacRoleBindingTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) Uid() *string {
	var returns *string
	_jsii_.Get(
		j,
		"uid",
...
func (j *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) UpdateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updateTime",
...
func (j *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) User() *string {
	var returns *string
	_jsii_.Get(
		j,
		"user",
...
func (j *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) UserInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"userInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.25.0/docs/resources/google_gke_hub_scope_rbac_role_binding google_gke_hub_scope_rbac_role_binding} Resource.
func NewGoogleGkeHubScopeRbacRoleBinding(scope constructs.Construct, id *string, config *GoogleGkeHubScopeRbacRoleBindingConfig) GoogleGkeHubScopeRbacRoleBinding {
	...
	if err := validateNewGoogleGkeHubScopeRbacRoleBindingParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_GoogleGkeHubScopeRbacRoleBinding{}

	_jsii_.Create(
		"@cdktf/provider-google-beta.googleGkeHubScopeRbacRoleBinding.GoogleGkeHubScopeRbacRoleBinding",
...
func GoogleGkeHubScopeRbacRoleBinding_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google-beta.googleGkeHubScopeRbacRoleBinding.GoogleGkeHubScopeRbacRoleBinding",
...
func (g *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (g *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (g *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (g *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (g *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (g *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) GetStringAttribute(terraformAttribute *string) *string {
...
func (g *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (g *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) MoveToId(id *string) {
...
func (g *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) OverrideLogicalId(newLogicalId *string) {
...
func (g *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) PutRole(value *GoogleGkeHubScopeRbacRoleBindingRole) {
...
func (g *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) PutTimeouts(value *GoogleGkeHubScopeRbacRoleBindingTimeouts) {
...
func (g *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) ResetGroup() {
	_jsii_.InvokeVoid(
		g,
		"resetGroup",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) ResetId() {
	_jsii_.InvokeVoid(
		g,
		"resetId",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		g,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) ResetProject() {
	_jsii_.InvokeVoid(
		g,
		"resetProject",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) ResetTimeouts() {
	_jsii_.InvokeVoid(
		g,
		"resetTimeouts",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) ResetUser() {
	_jsii_.InvokeVoid(
		g,
		"resetUser",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) ToString() *string {
	var returns *string
