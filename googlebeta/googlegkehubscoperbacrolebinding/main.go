...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "scopeRbacRoleBindingId", GoGetter: "ScopeRbacRoleBindingId"},
			_jsii_.MemberProperty{JsiiProperty: "scopeRbacRoleBindingIdInput", GoGetter: "ScopeRbacRoleBindingIdInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google-beta.googleGkeHubScopeRbacRoleBinding.GoogleGkeHubScopeRbacRoleBindingConfig",
		reflect.TypeOf((*GoogleGkeHubScopeRbacRoleBindingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google-beta.googleGkeHubScopeRbacRoleBinding.GoogleGkeHubScopeRbacRoleBindingRole",
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "customRole", GoGetter: "CustomRole"},
			_jsii_.MemberProperty{JsiiProperty: "customRoleInput", GoGetter: "CustomRoleInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "predefinedRole", GoGetter: "PredefinedRole"},
			_jsii_.MemberProperty{JsiiProperty: "predefinedRoleInput", GoGetter: "PredefinedRoleInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetCustomRole", GoMethod: "ResetCustomRole"},
			_jsii_.MemberMethod{JsiiMethod: "resetPredefinedRole", GoMethod: "ResetPredefinedRole"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google-beta.googleGkeHubScopeRbacRoleBinding.GoogleGkeHubScopeRbacRoleBindingState",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google-beta.googleGkeHubScopeRbacRoleBinding.GoogleGkeHubScopeRbacRoleBindingTimeouts",
