...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "isUpgradable", GoGetter: "IsUpgradable"},
			...
			_jsii_.MemberProperty{JsiiProperty: "notebookRuntimeTemplateRef", GoGetter: "NotebookRuntimeTemplateRef"},
			_jsii_.MemberProperty{JsiiProperty: "notebookRuntimeTemplateRefInput", GoGetter: "NotebookRuntimeTemplateRefInput"},
			_jsii_.MemberProperty{JsiiProperty: "notebookRuntimeType", GoGetter: "NotebookRuntimeType"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetNotebookRuntimeTemplateRef", GoMethod: "ResetNotebookRuntimeTemplateRef"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetProject", GoMethod: "ResetProject"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "runtimeUser", GoGetter: "RuntimeUser"},
			_jsii_.MemberProperty{JsiiProperty: "runtimeUserInput", GoGetter: "RuntimeUserInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "notebookRuntimeTemplate", GoGetter: "NotebookRuntimeTemplate"},
			_jsii_.MemberProperty{JsiiProperty: "notebookRuntimeTemplateInput", GoGetter: "NotebookRuntimeTemplateInput"},
