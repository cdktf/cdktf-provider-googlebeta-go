...
func (j *jsiiProxy_DataGoogleNetworkManagementConnectivityTestRunReachabilityDetailsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleNetworkManagementConnectivityTestRunReachabilityDetailsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleNetworkManagementConnectivityTestRunReachabilityDetailsList {
	_init_.Initialize()
...
func NewDataGoogleNetworkManagementConnectivityTestRunReachabilityDetailsList_Override(d DataGoogleNetworkManagementConnectivityTestRunReachabilityDetailsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleNetworkManagementConnectivityTestRunReachabilityDetailsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleNetworkManagementConnectivityTestRunReachabilityDetailsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleNetworkManagementConnectivityTestRunReachabilityDetailsList) Resolve(_context cdktf.IResolveContext) interface{} {
