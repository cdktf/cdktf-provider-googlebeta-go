...
import (
	...
	"github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13/googlenetworksecuritygatewaysecuritypolicyrule/internal"
...
func (g *jsiiProxy_GoogleNetworkSecurityGatewaySecurityPolicyRule) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleNetworkSecurityGatewaySecurityPolicyRule) MoveToId(id *string) {
