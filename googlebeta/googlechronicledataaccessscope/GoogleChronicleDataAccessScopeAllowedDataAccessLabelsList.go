...
func (j *jsiiProxy_GoogleChronicleDataAccessScopeAllowedDataAccessLabelsList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_GoogleChronicleDataAccessScopeAllowedDataAccessLabelsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleChronicleDataAccessScopeAllowedDataAccessLabelsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleChronicleDataAccessScopeAllowedDataAccessLabelsList) Resolve(_context cdktf.IResolveContext) interface{} {
