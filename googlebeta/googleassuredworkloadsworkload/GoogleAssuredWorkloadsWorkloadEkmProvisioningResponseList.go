...
import (
	...
	"github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13/googleassuredworkloadsworkload/internal"
...
func (g *jsiiProxy_GoogleAssuredWorkloadsWorkloadEkmProvisioningResponseList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
