...
type GoogleDialogflowCxFlowTransitionRoutesTriggerFulfillmentMessages struct {
	// text block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/4.74.0/docs/resources/google_dialogflow_cx_flow#text GoogleDialogflowCxFlow#text}
