...
import (
	...
	"github.com/hashicorp/cdktf-provider-googlebeta-go/googlebeta/v3/googleprivatecacertificatetemplateiambinding/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://www.terraform.io/docs/providers/google-beta/r/google_privateca_certificate_template_iam_binding google_privateca_certificate_template_iam_binding}.
...
func (j *jsiiProxy_GooglePrivatecaCertificateTemplateIamBinding) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://www.terraform.io/docs/providers/google-beta/r/google_privateca_certificate_template_iam_binding google_privateca_certificate_template_iam_binding} Resource.
...
func (j *jsiiProxy_GooglePrivatecaCertificateTemplateIamBinding)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
