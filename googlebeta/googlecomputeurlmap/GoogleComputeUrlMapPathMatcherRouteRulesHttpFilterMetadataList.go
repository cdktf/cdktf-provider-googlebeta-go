...
func (j *jsiiProxy_GoogleComputeUrlMapPathMatcherRouteRulesHttpFilterMetadataList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleComputeUrlMapPathMatcherRouteRulesHttpFilterMetadataList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleComputeUrlMapPathMatcherRouteRulesHttpFilterMetadataList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktf/provider-google-beta.googleComputeUrlMap.GoogleComputeUrlMapPathMatcherRouteRulesHttpFilterMetadataList",
...
func NewGoogleComputeUrlMapPathMatcherRouteRulesHttpFilterMetadataList_Override(g GoogleComputeUrlMapPathMatcherRouteRulesHttpFilterMetadataList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleComputeUrlMapPathMatcherRouteRulesHttpFilterMetadataList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleComputeUrlMapPathMatcherRouteRulesHttpFilterMetadataList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleComputeUrlMapPathMatcherRouteRulesHttpFilterMetadataList) Resolve(_context cdktf.IResolveContext) interface{} {
