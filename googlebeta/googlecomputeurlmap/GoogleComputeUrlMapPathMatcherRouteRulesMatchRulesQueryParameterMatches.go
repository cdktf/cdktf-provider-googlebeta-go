...
type GoogleComputeUrlMapPathMatcherRouteRulesMatchRulesQueryParameterMatches struct {
	...
	// must be set.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.15.0/docs/resources/google_compute_url_map#exact_match GoogleComputeUrlMap#exact_match}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.15.0/docs/resources/google_compute_url_map#present_match GoogleComputeUrlMap#present_match}
