...
func (g *jsiiProxy_GoogleFirebaseAppHostingTrafficCurrentSplitsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (g *jsiiProxy_GoogleFirebaseAppHostingTrafficCurrentSplitsList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_GoogleFirebaseAppHostingTrafficCurrentSplitsList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_GoogleFirebaseAppHostingTrafficCurrentSplitsList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
