...
func (j *jsiiProxy_GoogleGkeHubFeatureSpecOutputReference) Clusterupgrade() GoogleGkeHubFeatureSpecClusterupgradeOutputReference {
	var returns GoogleGkeHubFeatureSpecClusterupgradeOutputReference
	_jsii_.Get(
		j,
		"clusterupgrade",
		&returns,
...
func (j *jsiiProxy_GoogleGkeHubFeatureSpecOutputReference) ClusterupgradeInput() *GoogleGkeHubFeatureSpecClusterupgrade {
...
func (j *jsiiProxy_GoogleGkeHubFeatureSpecOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_GoogleGkeHubFeatureSpecOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleGkeHubFeatureSpecOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_GoogleGkeHubFeatureSpecOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GoogleGkeHubFeatureSpecOutputReference) InternalValue() *GoogleGkeHubFeatureSpec {
...
func (j *jsiiProxy_GoogleGkeHubFeatureSpecOutputReference) Multiclusteringress() GoogleGkeHubFeatureSpecMulticlusteringressOutputReference {
	var returns GoogleGkeHubFeatureSpecMulticlusteringressOutputReference
	_jsii_.Get(
		j,
		"multiclusteringress",
		&returns,
...
func (j *jsiiProxy_GoogleGkeHubFeatureSpecOutputReference) MulticlusteringressInput() *GoogleGkeHubFeatureSpecMulticlusteringress {
...
func (j *jsiiProxy_GoogleGkeHubFeatureSpecOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_GoogleGkeHubFeatureSpecOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_GoogleGkeHubFeatureSpecOutputReference)SetInternalValue(val *GoogleGkeHubFeatureSpec) {
...
func (j *jsiiProxy_GoogleGkeHubFeatureSpecOutputReference)SetTerraformAttribute(val *string) {
...
func (g *jsiiProxy_GoogleGkeHubFeatureSpecOutputReference) ComputeFqn() *string {
	var returns *string
...
func (g *jsiiProxy_GoogleGkeHubFeatureSpecOutputReference) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (g *jsiiProxy_GoogleGkeHubFeatureSpecOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (g *jsiiProxy_GoogleGkeHubFeatureSpecOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (g *jsiiProxy_GoogleGkeHubFeatureSpecOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (g *jsiiProxy_GoogleGkeHubFeatureSpecOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (g *jsiiProxy_GoogleGkeHubFeatureSpecOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (g *jsiiProxy_GoogleGkeHubFeatureSpecOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (g *jsiiProxy_GoogleGkeHubFeatureSpecOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (g *jsiiProxy_GoogleGkeHubFeatureSpecOutputReference) PutClusterupgrade(value *GoogleGkeHubFeatureSpecClusterupgrade) {
...
func (g *jsiiProxy_GoogleGkeHubFeatureSpecOutputReference) ResetMulticlusteringress() {
	_jsii_.InvokeVoid(
		g,
		"resetMulticlusteringress",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleGkeHubFeatureSpecOutputReference) ToString() *string {
	var returns *string
