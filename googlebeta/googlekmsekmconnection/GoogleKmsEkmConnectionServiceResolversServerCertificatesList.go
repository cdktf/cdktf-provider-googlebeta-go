...
func (j *jsiiProxy_GoogleKmsEkmConnectionServiceResolversServerCertificatesList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleKmsEkmConnectionServiceResolversServerCertificatesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleKmsEkmConnectionServiceResolversServerCertificatesList {
	_init_.Initialize()
...
func NewGoogleKmsEkmConnectionServiceResolversServerCertificatesList_Override(g GoogleKmsEkmConnectionServiceResolversServerCertificatesList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleKmsEkmConnectionServiceResolversServerCertificatesList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleKmsEkmConnectionServiceResolversServerCertificatesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleKmsEkmConnectionServiceResolversServerCertificatesList) Resolve(_context cdktf.IResolveContext) interface{} {
