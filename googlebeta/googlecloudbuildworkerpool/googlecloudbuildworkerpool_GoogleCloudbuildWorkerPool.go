...
import (
	...
	"github.com/hashicorp/cdktf-provider-googlebeta-go/googlebeta/v3/googlecloudbuildworkerpool/internal"
...
func (j *jsiiProxy_GoogleCloudbuildWorkerPool) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_GoogleCloudbuildWorkerPool)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
