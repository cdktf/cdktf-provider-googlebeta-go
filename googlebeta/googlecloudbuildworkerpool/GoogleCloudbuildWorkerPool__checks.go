...
func (g *jsiiProxy_GoogleCloudbuildWorkerPool) validateMoveFromIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (g *jsiiProxy_GoogleCloudbuildWorkerPool) validateMoveToIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (g *jsiiProxy_GoogleCloudbuildWorkerPool) validatePutPrivateServiceConnectParameters(value *GoogleCloudbuildWorkerPoolPrivateServiceConnect) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	if err := _jsii_.ValidateStruct(value, func() string { return "parameter value" }); err != nil {
