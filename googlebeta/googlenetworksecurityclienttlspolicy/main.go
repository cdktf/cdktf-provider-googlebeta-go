...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetServerValidationCa", GoMethod: "ResetServerValidationCa"},
			_jsii_.MemberMethod{JsiiMethod: "resetSni", GoMethod: "ResetSni"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "serverValidationCa", GoGetter: "ServerValidationCa"},
			_jsii_.MemberProperty{JsiiProperty: "serverValidationCaInput", GoGetter: "ServerValidationCaInput"},
