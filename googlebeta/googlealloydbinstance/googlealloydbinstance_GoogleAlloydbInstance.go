...
import (
	...
	"github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googlealloydbinstance/internal"
...
func (j *jsiiProxy_GoogleAlloydbInstance) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_GoogleAlloydbInstance)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
