...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "googleApiSourceId", GoGetter: "GoogleApiSourceId"},
			_jsii_.MemberProperty{JsiiProperty: "googleApiSourceIdInput", GoGetter: "GoogleApiSourceIdInput"},
