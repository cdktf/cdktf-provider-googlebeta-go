...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "backupRegionInput", GoGetter: "BackupRegionInput"},
			_jsii_.MemberProperty{JsiiProperty: "backupRetentionPolicy", GoGetter: "BackupRetentionPolicy"},
			_jsii_.MemberProperty{JsiiProperty: "backupRetentionPolicyInput", GoGetter: "BackupRetentionPolicyInput"},
			_jsii_.MemberProperty{JsiiProperty: "backupVaultType", GoGetter: "BackupVaultType"},
			_jsii_.MemberProperty{JsiiProperty: "backupVaultTypeInput", GoGetter: "BackupVaultTypeInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "destinationBackupVault", GoGetter: "DestinationBackupVault"},
			...
			_jsii_.MemberProperty{JsiiProperty: "sourceBackupVault", GoGetter: "SourceBackupVault"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "dailyBackupImmutable", GoGetter: "DailyBackupImmutable"},
			_jsii_.MemberProperty{JsiiProperty: "dailyBackupImmutableInput", GoGetter: "DailyBackupImmutableInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "manualBackupImmutable", GoGetter: "ManualBackupImmutable"},
			_jsii_.MemberProperty{JsiiProperty: "manualBackupImmutableInput", GoGetter: "ManualBackupImmutableInput"},
			_jsii_.MemberProperty{JsiiProperty: "monthlyBackupImmutable", GoGetter: "MonthlyBackupImmutable"},
			_jsii_.MemberProperty{JsiiProperty: "monthlyBackupImmutableInput", GoGetter: "MonthlyBackupImmutableInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetDailyBackupImmutable", GoMethod: "ResetDailyBackupImmutable"},
			_jsii_.MemberMethod{JsiiMethod: "resetManualBackupImmutable", GoMethod: "ResetManualBackupImmutable"},
			_jsii_.MemberMethod{JsiiMethod: "resetMonthlyBackupImmutable", GoMethod: "ResetMonthlyBackupImmutable"},
			_jsii_.MemberMethod{JsiiMethod: "resetWeeklyBackupImmutable", GoMethod: "ResetWeeklyBackupImmutable"},
