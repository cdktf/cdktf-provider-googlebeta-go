...
func (g *jsiiProxy_GoogleNetworkSecurityAuthzPolicyHttpRulesToOperationsHeaderSetHeadersList) validateResolveParameters(_context cdktf.IResolveContext) error {
	return nil
}
