...
func (j *jsiiProxy_GoogleApihubPluginInstanceActionsHubInstanceActionLastExecutionList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleApihubPluginInstanceActionsHubInstanceActionLastExecutionList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleApihubPluginInstanceActionsHubInstanceActionLastExecutionList {
	_init_.Initialize()
...
func NewGoogleApihubPluginInstanceActionsHubInstanceActionLastExecutionList_Override(g GoogleApihubPluginInstanceActionsHubInstanceActionLastExecutionList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleApihubPluginInstanceActionsHubInstanceActionLastExecutionList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleApihubPluginInstanceActionsHubInstanceActionLastExecutionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleApihubPluginInstanceActionsHubInstanceActionLastExecutionList) Resolve(_context cdktf.IResolveContext) interface{} {
