...
import (
	...
	"github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16/datagoogleartifactregistrytag/internal"
...
func NewDataGoogleArtifactRegistryTag(scope constructs.Construct, id *string, config *DataGoogleArtifactRegistryTagConfig) DataGoogleArtifactRegistryTag {
	...
	_jsii_.Create(
		"@cdktf/provider-google-beta.dataGoogleArtifactRegistryTag.DataGoogleArtifactRegistryTag",
