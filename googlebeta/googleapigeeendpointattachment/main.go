...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "endpointAttachmentId", GoGetter: "EndpointAttachmentId"},
			_jsii_.MemberProperty{JsiiProperty: "endpointAttachmentIdInput", GoGetter: "EndpointAttachmentIdInput"},
