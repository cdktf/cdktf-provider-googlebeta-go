...
type GoogleBeyondcorpSecurityGatewayIamMemberConfig struct {
	// Experimental.
	...
	Condition *GoogleBeyondcorpSecurityGatewayIamMemberCondition `field:"optional" json:"condition" yaml:"condition"`
