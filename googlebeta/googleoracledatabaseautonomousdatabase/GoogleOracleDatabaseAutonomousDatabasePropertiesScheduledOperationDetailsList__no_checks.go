...
func (g *jsiiProxy_GoogleOracleDatabaseAutonomousDatabasePropertiesScheduledOperationDetailsList) validateResolveParameters(_context cdktf.IResolveContext) error {
	return nil
}
