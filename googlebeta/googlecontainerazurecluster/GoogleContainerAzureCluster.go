...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.38.0/docs/resources/google_container_azure_cluster google_container_azure_cluster}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.38.0/docs/resources/google_container_azure_cluster google_container_azure_cluster} Resource.
...
func GoogleContainerAzureCluster_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleContainerAzureCluster_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleContainerAzureCluster) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleContainerAzureCluster) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleContainerAzureCluster) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleContainerAzureCluster) MoveToId(id *string) {
