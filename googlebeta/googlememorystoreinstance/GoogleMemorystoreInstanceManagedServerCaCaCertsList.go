...
func (j *jsiiProxy_GoogleMemorystoreInstanceManagedServerCaCaCertsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleMemorystoreInstanceManagedServerCaCaCertsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleMemorystoreInstanceManagedServerCaCaCertsList {
	_init_.Initialize()
...
func NewGoogleMemorystoreInstanceManagedServerCaCaCertsList_Override(g GoogleMemorystoreInstanceManagedServerCaCaCertsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleMemorystoreInstanceManagedServerCaCaCertsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleMemorystoreInstanceManagedServerCaCaCertsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleMemorystoreInstanceManagedServerCaCaCertsList) Resolve(_context cdktf.IResolveContext) interface{} {
