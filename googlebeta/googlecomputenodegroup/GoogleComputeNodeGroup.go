...
import (
	...
	"github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14/googlecomputenodegroup/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.25.0/docs/resources/google_compute_node_group google_compute_node_group} Resource.
...
func GoogleComputeNodeGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleComputeNodeGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleComputeNodeGroup) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleComputeNodeGroup) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleComputeNodeGroup) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleComputeNodeGroup) MoveToId(id *string) {
