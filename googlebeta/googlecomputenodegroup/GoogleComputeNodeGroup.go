...
import (
	...
	"github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googlecomputenodegroup/internal"
...
func (j *jsiiProxy_GoogleComputeNodeGroup) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_GoogleComputeNodeGroup)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
