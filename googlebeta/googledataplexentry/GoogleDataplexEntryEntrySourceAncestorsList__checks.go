...
func (g *jsiiProxy_GoogleDataplexEntryEntrySourceAncestorsList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_GoogleDataplexEntryEntrySourceAncestorsList) validateSetInternalValueParameters(val interface{}) error {
	...
	case []*GoogleDataplexEntryEntrySourceAncestors:
		val_ := val.([]*GoogleDataplexEntryEntrySourceAncestors)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
...
func (j *jsiiProxy_GoogleDataplexEntryEntrySourceAncestorsList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_GoogleDataplexEntryEntrySourceAncestorsList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
