...
import (
	...
	"github.com/hashicorp/cdktf-provider-googlebeta-go/googlebeta/v3/googlerecaptchaenterprisekey/internal"
...
func (j *jsiiProxy_GoogleRecaptchaEnterpriseKey) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_GoogleRecaptchaEnterpriseKey)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
