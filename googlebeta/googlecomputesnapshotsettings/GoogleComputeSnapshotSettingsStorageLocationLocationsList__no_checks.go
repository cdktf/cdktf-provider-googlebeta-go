...
func (g *jsiiProxy_GoogleComputeSnapshotSettingsStorageLocationLocationsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (g *jsiiProxy_GoogleComputeSnapshotSettingsStorageLocationLocationsList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_GoogleComputeSnapshotSettingsStorageLocationLocationsList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_GoogleComputeSnapshotSettingsStorageLocationLocationsList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
