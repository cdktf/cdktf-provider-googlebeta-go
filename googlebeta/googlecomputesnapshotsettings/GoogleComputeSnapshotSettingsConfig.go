...
type GoogleComputeSnapshotSettingsConfig struct {
	// Experimental.
	...
	StorageLocation *GoogleComputeSnapshotSettingsStorageLocation `field:"required" json:"storageLocation" yaml:"storageLocation"`
	...
	Timeouts *GoogleComputeSnapshotSettingsTimeouts `field:"optional" json:"timeouts" yaml:"timeouts"`
}
