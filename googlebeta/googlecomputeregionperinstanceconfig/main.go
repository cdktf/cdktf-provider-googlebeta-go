...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRemoveInstanceOnDestroy", GoMethod: "ResetRemoveInstanceOnDestroy"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putInternalIp", GoMethod: "PutInternalIp"},
