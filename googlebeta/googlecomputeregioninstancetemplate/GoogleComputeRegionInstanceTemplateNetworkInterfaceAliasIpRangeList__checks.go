...
func (g *jsiiProxy_GoogleComputeRegionInstanceTemplateNetworkInterfaceAliasIpRangeList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_GoogleComputeRegionInstanceTemplateNetworkInterfaceAliasIpRangeList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_GoogleComputeRegionInstanceTemplateNetworkInterfaceAliasIpRangeList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
