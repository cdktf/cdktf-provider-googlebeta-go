...
func (j *jsiiProxy_GoogleClouddeployTargetGkeOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_GoogleClouddeployTargetGkeOutputReference) InternalIp() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalIp",
...
func (j *jsiiProxy_GoogleClouddeployTargetGkeOutputReference) InternalIpInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalIpInput",
...
func (j *jsiiProxy_GoogleClouddeployTargetGkeOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_GoogleClouddeployTargetGkeOutputReference)SetInternalIp(val interface{}) {
...
func (g *jsiiProxy_GoogleClouddeployTargetGkeOutputReference) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
