...
import (
	...
	"github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13/googlecomputeinstance/internal"
...
func (g *jsiiProxy_GoogleComputeInstanceNetworkInterfaceAliasIpRangeList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
