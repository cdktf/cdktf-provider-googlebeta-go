...
func (j *jsiiProxy_DataGoogleComputeRegionBackendServiceLogConfigList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleComputeRegionBackendServiceLogConfigList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleComputeRegionBackendServiceLogConfigList {
	_init_.Initialize()
...
func NewDataGoogleComputeRegionBackendServiceLogConfigList_Override(d DataGoogleComputeRegionBackendServiceLogConfigList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleComputeRegionBackendServiceLogConfigList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleComputeRegionBackendServiceLogConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleComputeRegionBackendServiceLogConfigList) Resolve(_context cdktf.IResolveContext) interface{} {
