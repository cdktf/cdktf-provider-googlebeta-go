...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "customWriterIdentity", GoGetter: "CustomWriterIdentity"},
			_jsii_.MemberProperty{JsiiProperty: "customWriterIdentityInput", GoGetter: "CustomWriterIdentityInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetUniqueWriterIdentity", GoMethod: "ResetUniqueWriterIdentity"},
