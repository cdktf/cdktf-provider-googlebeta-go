...
import (
	...
	"github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13/googleloggingprojectsink/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.15.0/docs/resources/google_logging_project_sink google_logging_project_sink}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.15.0/docs/resources/google_logging_project_sink google_logging_project_sink} Resource.
...
func GoogleLoggingProjectSink_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleLoggingProjectSink_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleLoggingProjectSink) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleLoggingProjectSink) HasResourceMove() interface{} {
	var returns interface{}
...
func (g *jsiiProxy_GoogleLoggingProjectSink) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleLoggingProjectSink) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleLoggingProjectSink) MoveTo(moveTarget *string, index interface{}) {
...
func (g *jsiiProxy_GoogleLoggingProjectSink) MoveToId(id *string) {
...
func (g *jsiiProxy_GoogleLoggingProjectSink) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (g *jsiiProxy_GoogleLoggingProjectSink) ToHclTerraform() interface{} {
	var returns interface{}
