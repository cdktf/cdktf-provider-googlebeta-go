...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "endpointTypesInput", GoGetter: "EndpointTypesInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "initialNatIpsInput", GoGetter: "InitialNatIpsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEndpointTypes", GoMethod: "ResetEndpointTypes"},
			_jsii_.MemberMethod{JsiiMethod: "resetIcmpIdleTimeoutSec", GoMethod: "ResetIcmpIdleTimeoutSec"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetInitialNatIps", GoMethod: "ResetInitialNatIps"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSourceNatActiveRanges", GoMethod: "ResetSourceNatActiveRanges"},
			_jsii_.MemberMethod{JsiiMethod: "resetSourceNatDrainIps", GoMethod: "ResetSourceNatDrainIps"},
			_jsii_.MemberMethod{JsiiMethod: "resetSourceNatDrainRanges", GoMethod: "ResetSourceNatDrainRanges"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			...
			_jsii_.MemberProperty{JsiiProperty: "sourceNatActiveRangesInput", GoGetter: "SourceNatActiveRangesInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "sourceNatDrainRangesInput", GoGetter: "SourceNatDrainRangesInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
