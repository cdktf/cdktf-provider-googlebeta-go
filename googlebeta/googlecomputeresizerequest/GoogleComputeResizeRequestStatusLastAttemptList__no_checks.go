...
func (g *jsiiProxy_GoogleComputeResizeRequestStatusLastAttemptList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (g *jsiiProxy_GoogleComputeResizeRequestStatusLastAttemptList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_GoogleComputeResizeRequestStatusLastAttemptList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_GoogleComputeResizeRequestStatusLastAttemptList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
