...
func (g *jsiiProxy_GoogleComputeResizeRequestStatusList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (g *jsiiProxy_GoogleComputeResizeRequestStatusList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_GoogleComputeResizeRequestStatusList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_GoogleComputeResizeRequestStatusList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
