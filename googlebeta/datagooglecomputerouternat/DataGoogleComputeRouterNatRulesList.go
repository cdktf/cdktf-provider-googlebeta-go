...
import (
	...
	"github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/datagooglecomputerouternat/internal"
...
func (d *jsiiProxy_DataGoogleComputeRouterNatRulesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
