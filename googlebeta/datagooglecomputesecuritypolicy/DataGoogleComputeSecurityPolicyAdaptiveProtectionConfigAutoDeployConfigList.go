...
func (j *jsiiProxy_DataGoogleComputeSecurityPolicyAdaptiveProtectionConfigAutoDeployConfigList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleComputeSecurityPolicyAdaptiveProtectionConfigAutoDeployConfigList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleComputeSecurityPolicyAdaptiveProtectionConfigAutoDeployConfigList {
	_init_.Initialize()
...
func NewDataGoogleComputeSecurityPolicyAdaptiveProtectionConfigAutoDeployConfigList_Override(d DataGoogleComputeSecurityPolicyAdaptiveProtectionConfigAutoDeployConfigList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleComputeSecurityPolicyAdaptiveProtectionConfigAutoDeployConfigList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleComputeSecurityPolicyAdaptiveProtectionConfigAutoDeployConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleComputeSecurityPolicyAdaptiveProtectionConfigAutoDeployConfigList) Resolve(_context cdktf.IResolveContext) interface{} {
