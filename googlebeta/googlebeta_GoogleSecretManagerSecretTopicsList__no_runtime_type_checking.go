...
func (g *jsiiProxy_GoogleSecretManagerSecretTopicsList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_GoogleSecretManagerSecretTopicsList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_GoogleSecretManagerSecretTopicsList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
