...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "playbookType", GoGetter: "PlaybookType"},
			_jsii_.MemberProperty{JsiiProperty: "playbookTypeInput", GoGetter: "PlaybookTypeInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "referencedFlows", GoGetter: "ReferencedFlows"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPlaybookType", GoMethod: "ResetPlaybookType"},
			_jsii_.MemberMethod{JsiiMethod: "resetReferencedTools", GoMethod: "ResetReferencedTools"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "getStringAttribute", GoMethod: "GetStringAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getStringMapAttribute", GoMethod: "GetStringMapAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "guidelines", GoGetter: "Guidelines"},
			_jsii_.MemberProperty{JsiiProperty: "guidelinesInput", GoGetter: "GuidelinesInput"},
			_jsii_.MemberProperty{JsiiProperty: "internalValue", GoGetter: "InternalValue"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "putSteps", GoMethod: "PutSteps"},
			_jsii_.MemberMethod{JsiiMethod: "resetGuidelines", GoMethod: "ResetGuidelines"},
