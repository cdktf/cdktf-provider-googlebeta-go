...
func (j *jsiiProxy_DataGoogleComputeRegionInstanceTemplate) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://www.terraform.io/docs/providers/google-beta/d/google_compute_region_instance_template google_compute_region_instance_template} Data Source.
...
func (j *jsiiProxy_DataGoogleComputeRegionInstanceTemplate)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
