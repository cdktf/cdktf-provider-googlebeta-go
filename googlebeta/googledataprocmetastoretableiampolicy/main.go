...
package googledataprocmetastoretableiampolicy
...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google-beta.googleDataprocMetastoreTableIamPolicy.GoogleDataprocMetastoreTableIamPolicy",
		reflect.TypeOf((*GoogleDataprocMetastoreTableIamPolicy)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_GoogleDataprocMetastoreTableIamPolicy{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfTerraformResource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google-beta.googleDataprocMetastoreTableIamPolicy.GoogleDataprocMetastoreTableIamPolicyConfig",
		reflect.TypeOf((*GoogleDataprocMetastoreTableIamPolicyConfig)(nil)).Elem(),
	)
}
