...
func (g *jsiiProxy_GoogleCloudIdentityGroupMembership) validatePutRolesParameters(value interface{}) error {
	...
	case *[]*GoogleCloudIdentityGroupMembershipRoles:
		value := value.(*[]*GoogleCloudIdentityGroupMembershipRoles)
	...
	case []*GoogleCloudIdentityGroupMembershipRoles:
		value_ := value.([]*GoogleCloudIdentityGroupMembershipRoles)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*GoogleCloudIdentityGroupMembershipRoles; received %#v (a %T)", value, value)
		}
	}
