...
import (
	...
	"github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googlenetworkconnectivityspoke/internal"
...
func (j *jsiiProxy_GoogleNetworkConnectivitySpoke) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_GoogleNetworkConnectivitySpoke)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
