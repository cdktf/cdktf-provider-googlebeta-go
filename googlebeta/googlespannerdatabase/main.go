...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "enableDropProtectionInput", GoGetter: "EnableDropProtectionInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEnableDropProtection", GoMethod: "ResetEnableDropProtection"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "kmsKeyNamesInput", GoGetter: "KmsKeyNamesInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetKmsKeyName", GoMethod: "ResetKmsKeyName"},
			_jsii_.MemberMethod{JsiiMethod: "resetKmsKeyNames", GoMethod: "ResetKmsKeyNames"},
