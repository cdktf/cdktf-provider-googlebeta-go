...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putRagManagedDbConfig", GoMethod: "PutRagManagedDbConfig"},
			_jsii_.MemberMethod{JsiiMethod: "putTimeouts", GoMethod: "PutTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "ragManagedDbConfig", GoGetter: "RagManagedDbConfig"},
			_jsii_.MemberProperty{JsiiProperty: "ragManagedDbConfigInput", GoGetter: "RagManagedDbConfigInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putScaled", GoMethod: "PutScaled"},
			_jsii_.MemberMethod{JsiiMethod: "putUnprovisioned", GoMethod: "PutUnprovisioned"},
			_jsii_.MemberMethod{JsiiMethod: "resetBasic", GoMethod: "ResetBasic"},
			_jsii_.MemberMethod{JsiiMethod: "resetScaled", GoMethod: "ResetScaled"},
			_jsii_.MemberMethod{JsiiMethod: "resetUnprovisioned", GoMethod: "ResetUnprovisioned"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "scaled", GoGetter: "Scaled"},
			_jsii_.MemberProperty{JsiiProperty: "scaledInput", GoGetter: "ScaledInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
