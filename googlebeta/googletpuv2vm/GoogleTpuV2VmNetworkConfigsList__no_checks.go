...
func (g *jsiiProxy_GoogleTpuV2VmNetworkConfigsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (g *jsiiProxy_GoogleTpuV2VmNetworkConfigsList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_GoogleTpuV2VmNetworkConfigsList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_GoogleTpuV2VmNetworkConfigsList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
