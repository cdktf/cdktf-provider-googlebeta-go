...
func (j *jsiiProxy_GoogleNetworkSecurityMirroringEndpointGroupAssociationsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleNetworkSecurityMirroringEndpointGroupAssociationsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleNetworkSecurityMirroringEndpointGroupAssociationsList {
	_init_.Initialize()
...
func NewGoogleNetworkSecurityMirroringEndpointGroupAssociationsList_Override(g GoogleNetworkSecurityMirroringEndpointGroupAssociationsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleNetworkSecurityMirroringEndpointGroupAssociationsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleNetworkSecurityMirroringEndpointGroupAssociationsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleNetworkSecurityMirroringEndpointGroupAssociationsList) Resolve(_context cdktf.IResolveContext) interface{} {
