...
type GoogleManagedKafkaAclAclEntries struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.43.0/docs/resources/google_managed_kafka_acl#operation GoogleManagedKafkaAcl#operation}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.43.0/docs/resources/google_managed_kafka_acl#principal GoogleManagedKafkaAcl#principal}
	Principal *string `field:"required" json:"principal" yaml:"principal"`
	// The host. Must be set to "*" for Managed Service for Apache Kafka.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.43.0/docs/resources/google_managed_kafka_acl#host GoogleManagedKafkaAcl#host}
	Host *string `field:"optional" json:"host" yaml:"host"`
	// The permission type. Accepted values are (case insensitive): ALLOW, DENY.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.43.0/docs/resources/google_managed_kafka_acl#permission_type GoogleManagedKafkaAcl#permission_type}
