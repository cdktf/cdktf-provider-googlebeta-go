...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleSecureSourceManagerInstanceIamMember)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google-beta.googleSecureSourceManagerInstanceIamMember.GoogleSecureSourceManagerInstanceIamMemberCondition",
		reflect.TypeOf((*GoogleSecureSourceManagerInstanceIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleSecureSourceManagerInstanceIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google-beta.googleSecureSourceManagerInstanceIamMember.GoogleSecureSourceManagerInstanceIamMemberConfig",
		reflect.TypeOf((*GoogleSecureSourceManagerInstanceIamMemberConfig)(nil)).Elem(),
	)
}
