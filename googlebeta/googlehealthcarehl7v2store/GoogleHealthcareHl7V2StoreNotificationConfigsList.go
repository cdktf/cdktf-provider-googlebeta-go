...
import (
	...
	"github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14/googlehealthcarehl7v2store/internal"
...
func (g *jsiiProxy_GoogleHealthcareHl7V2StoreNotificationConfigsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
