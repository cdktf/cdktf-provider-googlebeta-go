...
func (g *jsiiProxy_GoogleContainerCluster) validatePutNodePoolParameters(value interface{}) error {
	...
	case *[]*GoogleContainerClusterNodePool:
		value := value.(*[]*GoogleContainerClusterNodePool)
	...
	case []*GoogleContainerClusterNodePool:
		value_ := value.([]*GoogleContainerClusterNodePool)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*GoogleContainerClusterNodePool; received %#v (a %T)", value, value)
		}
	}
