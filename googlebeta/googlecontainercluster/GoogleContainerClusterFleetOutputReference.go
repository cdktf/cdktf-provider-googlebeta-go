...
type GoogleContainerClusterFleetOutputReference interface {
	...
	// Experimental.
	Fqn() *string
	InternalValue() *GoogleContainerClusterFleet
	SetInternalValue(val *GoogleContainerClusterFleet)
	Membership() *string
	MembershipId() *string
...
func (j *jsiiProxy_GoogleContainerClusterFleetOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleContainerClusterFleetOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_GoogleContainerClusterFleetOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GoogleContainerClusterFleetOutputReference) InternalValue() *GoogleContainerClusterFleet {
...
func (j *jsiiProxy_GoogleContainerClusterFleetOutputReference) Membership() *string {
	var returns *string
	_jsii_.Get(
		j,
		"membership",
...
func (j *jsiiProxy_GoogleContainerClusterFleetOutputReference) MembershipId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"membershipId",
...
func (j *jsiiProxy_GoogleContainerClusterFleetOutputReference) MembershipLocation() *string {
	var returns *string
	_jsii_.Get(
		j,
		"membershipLocation",
...
func (j *jsiiProxy_GoogleContainerClusterFleetOutputReference) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_GoogleContainerClusterFleetOutputReference) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_GoogleContainerClusterFleetOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (g *jsiiProxy_GoogleContainerClusterFleetOutputReference) ComputeFqn() *string {
	var returns *string
...
func (g *jsiiProxy_GoogleContainerClusterFleetOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (g *jsiiProxy_GoogleContainerClusterFleetOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (g *jsiiProxy_GoogleContainerClusterFleetOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (g *jsiiProxy_GoogleContainerClusterFleetOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (g *jsiiProxy_GoogleContainerClusterFleetOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (g *jsiiProxy_GoogleContainerClusterFleetOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (g *jsiiProxy_GoogleContainerClusterFleetOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (g *jsiiProxy_GoogleContainerClusterFleetOutputReference) ToString() *string {
	var returns *string
