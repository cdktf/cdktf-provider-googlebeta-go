...
type GoogleContainerClusterAddonsConfigIstioConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/4.83.0/docs/resources/google_container_cluster#auth GoogleContainerCluster#auth}
