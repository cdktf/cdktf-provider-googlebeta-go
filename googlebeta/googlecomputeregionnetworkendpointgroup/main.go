...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "pscDataInput", GoGetter: "PscDataInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putPscData", GoMethod: "PutPscData"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPscData", GoMethod: "ResetPscData"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "producerPortInput", GoGetter: "ProducerPortInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetProducerPort", GoMethod: "ResetProducerPort"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
