...
func (d *jsiiProxy_DataGoogleComputeResourcePolicyInstanceSchedulePolicyList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_DataGoogleComputeResourcePolicyInstanceSchedulePolicyList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_DataGoogleComputeResourcePolicyInstanceSchedulePolicyList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
