...
import (
	...
	"github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13/datagoogleiamworkloadidentitypoolprovider/internal"
...
func (d *jsiiProxy_DataGoogleIamWorkloadIdentityPoolProviderAwsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
