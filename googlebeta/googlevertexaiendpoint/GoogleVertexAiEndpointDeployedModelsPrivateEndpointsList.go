...
import (
	...
	"github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlevertexaiendpoint/internal"
...
func (g *jsiiProxy_GoogleVertexAiEndpointDeployedModelsPrivateEndpointsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
