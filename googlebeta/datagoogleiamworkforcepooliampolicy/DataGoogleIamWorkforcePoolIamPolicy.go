...
package datagoogleiamworkforcepooliampolicy
...
import (
	...
	"github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16/datagoogleiamworkforcepooliampolicy/internal"
...
func (j *jsiiProxy_DataGoogleIamWorkforcePoolIamPolicy) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleIamWorkforcePoolIamPolicy) Etag() *string {
	var returns *string
	_jsii_.Get(
		j,
		"etag",
...
func (j *jsiiProxy_DataGoogleIamWorkforcePoolIamPolicy) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleIamWorkforcePoolIamPolicy) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleIamWorkforcePoolIamPolicy) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleIamWorkforcePoolIamPolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataGoogleIamWorkforcePoolIamPolicy) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_DataGoogleIamWorkforcePoolIamPolicy) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_DataGoogleIamWorkforcePoolIamPolicy) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleIamWorkforcePoolIamPolicy) PolicyData() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyData",
...
func (j *jsiiProxy_DataGoogleIamWorkforcePoolIamPolicy) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleIamWorkforcePoolIamPolicy) WorkforcePoolId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"workforcePoolId",
...
func (j *jsiiProxy_DataGoogleIamWorkforcePoolIamPolicy) WorkforcePoolIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.3/docs/data-sources/google_iam_workforce_pool_iam_policy google_iam_workforce_pool_iam_policy} Data Source.
func NewDataGoogleIamWorkforcePoolIamPolicy(scope constructs.Construct, id *string, config *DataGoogleIamWorkforcePoolIamPolicyConfig) DataGoogleIamWorkforcePoolIamPolicy {
	...
	if err := validateNewDataGoogleIamWorkforcePoolIamPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataGoogleIamWorkforcePoolIamPolicy_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google-beta.dataGoogleIamWorkforcePoolIamPolicy.DataGoogleIamWorkforcePoolIamPolicy",
...
func (d *jsiiProxy_DataGoogleIamWorkforcePoolIamPolicy) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleIamWorkforcePoolIamPolicy) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleIamWorkforcePoolIamPolicy) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleIamWorkforcePoolIamPolicy) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleIamWorkforcePoolIamPolicy) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleIamWorkforcePoolIamPolicy) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleIamWorkforcePoolIamPolicy) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleIamWorkforcePoolIamPolicy) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleIamWorkforcePoolIamPolicy) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleIamWorkforcePoolIamPolicy) ResetLocation() {
	_jsii_.InvokeVoid(
		d,
		"resetLocation",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleIamWorkforcePoolIamPolicy) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleIamWorkforcePoolIamPolicy) ToString() *string {
	var returns *string
