...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "policyMode", GoGetter: "PolicyMode"},
			_jsii_.MemberProperty{JsiiProperty: "policyModeInput", GoGetter: "PolicyModeInput"},
			_jsii_.MemberProperty{JsiiProperty: "presetTopology", GoGetter: "PresetTopology"},
			_jsii_.MemberProperty{JsiiProperty: "presetTopologyInput", GoGetter: "PresetTopologyInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPolicyMode", GoMethod: "ResetPolicyMode"},
			_jsii_.MemberMethod{JsiiMethod: "resetPresetTopology", GoMethod: "ResetPresetTopology"},
