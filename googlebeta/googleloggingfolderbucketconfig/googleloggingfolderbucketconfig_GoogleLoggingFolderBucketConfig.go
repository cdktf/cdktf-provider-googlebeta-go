...
import (
	...
	"github.com/hashicorp/cdktf-provider-googlebeta-go/googlebeta/v3/googleloggingfolderbucketconfig/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://www.terraform.io/docs/providers/google-beta/r/google_logging_folder_bucket_config google_logging_folder_bucket_config}.
...
func (j *jsiiProxy_GoogleLoggingFolderBucketConfig) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://www.terraform.io/docs/providers/google-beta/r/google_logging_folder_bucket_config google_logging_folder_bucket_config} Resource.
...
func (j *jsiiProxy_GoogleLoggingFolderBucketConfig)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
