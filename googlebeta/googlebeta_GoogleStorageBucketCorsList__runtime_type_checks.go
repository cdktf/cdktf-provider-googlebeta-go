...
func (g *jsiiProxy_GoogleStorageBucketCorsList) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_GoogleStorageBucketCorsList) validateSetInternalValueParameters(val interface{}) error {
	...
	case *[]*GoogleStorageBucketCors:
		val := val.(*[]*GoogleStorageBucketCors)
	...
	case []*GoogleStorageBucketCors:
		val_ := val.([]*GoogleStorageBucketCors)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*GoogleStorageBucketCors; received %#v (a %T)", val, val)
		}
	}
