...
func (g *jsiiProxy_GoogleApigeeApiProductOperationGroupOperationConfigsOutputReference) validatePutAttributesParameters(value interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*GoogleApigeeApiProductOperationGroupOperationConfigsAttributes:
		value := value.(*[]*GoogleApigeeApiProductOperationGroupOperationConfigsAttributes)
	...
	case []*GoogleApigeeApiProductOperationGroupOperationConfigsAttributes:
		value_ := value.([]*GoogleApigeeApiProductOperationGroupOperationConfigsAttributes)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*GoogleApigeeApiProductOperationGroupOperationConfigsAttributes; received %#v (a %T)", value, value)
		}
	}
...
func (g *jsiiProxy_GoogleApigeeApiProductOperationGroupOperationConfigsOutputReference) validatePutOperationsParameters(value interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*GoogleApigeeApiProductOperationGroupOperationConfigsOperations:
		value := value.(*[]*GoogleApigeeApiProductOperationGroupOperationConfigsOperations)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*GoogleApigeeApiProductOperationGroupOperationConfigsOperations:
		value_ := value.([]*GoogleApigeeApiProductOperationGroupOperationConfigsOperations)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*GoogleApigeeApiProductOperationGroupOperationConfigsOperations; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_GoogleApigeeApiProductOperationGroupOperationConfigsOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case *GoogleApigeeApiProductOperationGroupOperationConfigs:
		val := val.(*GoogleApigeeApiProductOperationGroupOperationConfigs)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case GoogleApigeeApiProductOperationGroupOperationConfigs:
		val_ := val.(GoogleApigeeApiProductOperationGroupOperationConfigs)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *GoogleApigeeApiProductOperationGroupOperationConfigs; received %#v (a %T)", val, val)
		}
	}
