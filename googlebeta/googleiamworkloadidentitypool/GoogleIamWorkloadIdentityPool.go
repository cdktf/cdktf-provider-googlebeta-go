...
func (j *jsiiProxy_GoogleIamWorkloadIdentityPool) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_GoogleIamWorkloadIdentityPool) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_GoogleIamWorkloadIdentityPool) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_GoogleIamWorkloadIdentityPool) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_GoogleIamWorkloadIdentityPool) DisplayNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayNameInput",
...
func (j *jsiiProxy_GoogleIamWorkloadIdentityPool) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_GoogleIamWorkloadIdentityPool) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GoogleIamWorkloadIdentityPool) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_GoogleIamWorkloadIdentityPool) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_GoogleIamWorkloadIdentityPool) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_GoogleIamWorkloadIdentityPool) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_GoogleIamWorkloadIdentityPool) Node() constructs.Node {
...
func (j *jsiiProxy_GoogleIamWorkloadIdentityPool) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_GoogleIamWorkloadIdentityPool) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_GoogleIamWorkloadIdentityPool) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_GoogleIamWorkloadIdentityPool) State() *string {
	var returns *string
	_jsii_.Get(
		j,
		"state",
...
func (j *jsiiProxy_GoogleIamWorkloadIdentityPool) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GoogleIamWorkloadIdentityPool) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleIamWorkloadIdentityPool) Timeouts() GoogleIamWorkloadIdentityPoolTimeoutsOutputReference {
	var returns GoogleIamWorkloadIdentityPoolTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_GoogleIamWorkloadIdentityPool) WorkloadIdentityPoolId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleIamWorkloadIdentityPool) WorkloadIdentityPoolIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.41.0/docs/resources/google_iam_workload_identity_pool google_iam_workload_identity_pool} Resource.
func NewGoogleIamWorkloadIdentityPool(scope constructs.Construct, id *string, config *GoogleIamWorkloadIdentityPoolConfig) GoogleIamWorkloadIdentityPool {
	...
	if err := validateNewGoogleIamWorkloadIdentityPoolParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func GoogleIamWorkloadIdentityPool_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleIamWorkloadIdentityPool_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func GoogleIamWorkloadIdentityPool_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google-beta.googleIamWorkloadIdentityPool.GoogleIamWorkloadIdentityPool",
...
func (g *jsiiProxy_GoogleIamWorkloadIdentityPool) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleIamWorkloadIdentityPool) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleIamWorkloadIdentityPool) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (g *jsiiProxy_GoogleIamWorkloadIdentityPool) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (g *jsiiProxy_GoogleIamWorkloadIdentityPool) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (g *jsiiProxy_GoogleIamWorkloadIdentityPool) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (g *jsiiProxy_GoogleIamWorkloadIdentityPool) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (g *jsiiProxy_GoogleIamWorkloadIdentityPool) GetStringAttribute(terraformAttribute *string) *string {
...
func (g *jsiiProxy_GoogleIamWorkloadIdentityPool) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (g *jsiiProxy_GoogleIamWorkloadIdentityPool) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleIamWorkloadIdentityPool) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleIamWorkloadIdentityPool) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleIamWorkloadIdentityPool) MoveToId(id *string) {
...
func (g *jsiiProxy_GoogleIamWorkloadIdentityPool) OverrideLogicalId(newLogicalId *string) {
...
func (g *jsiiProxy_GoogleIamWorkloadIdentityPool) ResetDescription() {
	_jsii_.InvokeVoid(
		g,
		"resetDescription",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleIamWorkloadIdentityPool) ResetDisabled() {
	_jsii_.InvokeVoid(
		g,
		"resetDisabled",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleIamWorkloadIdentityPool) ResetDisplayName() {
	_jsii_.InvokeVoid(
		g,
		"resetDisplayName",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleIamWorkloadIdentityPool) ResetId() {
	_jsii_.InvokeVoid(
		g,
		"resetId",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleIamWorkloadIdentityPool) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		g,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleIamWorkloadIdentityPool) ResetProject() {
	_jsii_.InvokeVoid(
		g,
		"resetProject",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleIamWorkloadIdentityPool) ResetTimeouts() {
	_jsii_.InvokeVoid(
		g,
		"resetTimeouts",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleIamWorkloadIdentityPool) ToString() *string {
	var returns *string
