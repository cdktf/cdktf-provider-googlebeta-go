...
import (
	...
	"github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/datagooglefirebaseappleappconfig/internal"
...
func (j *jsiiProxy_DataGoogleFirebaseAppleAppConfigA) AppIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"appIdInput",
...
func (j *jsiiProxy_DataGoogleFirebaseAppleAppConfigA) ConfigFileContents() *string {
	var returns *string
	_jsii_.Get(
		j,
		"configFileContents",
...
func (j *jsiiProxy_DataGoogleFirebaseAppleAppConfigA) ConfigFilename() *string {
	var returns *string
	_jsii_.Get(
		j,
		"configFilename",
...
func (j *jsiiProxy_DataGoogleFirebaseAppleAppConfigA) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleFirebaseAppleAppConfigA) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleFirebaseAppleAppConfigA) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleFirebaseAppleAppConfigA) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleFirebaseAppleAppConfigA) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataGoogleFirebaseAppleAppConfigA) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleFirebaseAppleAppConfigA) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DataGoogleFirebaseAppleAppConfigA) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DataGoogleFirebaseAppleAppConfigA) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewDataGoogleFirebaseAppleAppConfigA(scope constructs.Construct, id *string, config *DataGoogleFirebaseAppleAppConfigAConfig) DataGoogleFirebaseAppleAppConfigA {
	...
	if err := validateNewDataGoogleFirebaseAppleAppConfigAParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataGoogleFirebaseAppleAppConfigA)SetId(val *string) {
...
func DataGoogleFirebaseAppleAppConfigA_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google-beta.dataGoogleFirebaseAppleAppConfig.DataGoogleFirebaseAppleAppConfigA",
...
func (d *jsiiProxy_DataGoogleFirebaseAppleAppConfigA) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleFirebaseAppleAppConfigA) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleFirebaseAppleAppConfigA) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleFirebaseAppleAppConfigA) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleFirebaseAppleAppConfigA) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleFirebaseAppleAppConfigA) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleFirebaseAppleAppConfigA) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleFirebaseAppleAppConfigA) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleFirebaseAppleAppConfigA) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleFirebaseAppleAppConfigA) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleFirebaseAppleAppConfigA) ResetProject() {
	_jsii_.InvokeVoid(
		d,
		"resetProject",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleFirebaseAppleAppConfigA) ToString() *string {
	var returns *string
