...
func (j *jsiiProxy_GoogleComputeFutureReservationTimeWindowOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleComputeFutureReservationTimeWindowOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) GoogleComputeFutureReservationTimeWindowOutputReference {
	_init_.Initialize()
...
func NewGoogleComputeFutureReservationTimeWindowOutputReference_Override(g GoogleComputeFutureReservationTimeWindowOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleComputeFutureReservationTimeWindowOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleComputeFutureReservationTimeWindowOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleComputeFutureReservationTimeWindowOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (g *jsiiProxy_GoogleComputeFutureReservationTimeWindowOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleComputeFutureReservationTimeWindowOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
