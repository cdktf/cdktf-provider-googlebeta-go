...
import (
	...
	"github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14/datagooglebigtabletableiampolicy/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.24.0/docs/data-sources/google_bigtable_table_iam_policy google_bigtable_table_iam_policy}.
...
func (j *jsiiProxy_DataGoogleBigtableTableIamPolicy) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleBigtableTableIamPolicy) Etag() *string {
	var returns *string
	_jsii_.Get(
		j,
		"etag",
...
func (j *jsiiProxy_DataGoogleBigtableTableIamPolicy) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleBigtableTableIamPolicy) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleBigtableTableIamPolicy) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleBigtableTableIamPolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataGoogleBigtableTableIamPolicy) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleBigtableTableIamPolicy) PolicyData() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyData",
...
func (j *jsiiProxy_DataGoogleBigtableTableIamPolicy) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DataGoogleBigtableTableIamPolicy) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DataGoogleBigtableTableIamPolicy) Table() *string {
	var returns *string
	_jsii_.Get(
		j,
		"table",
...
func (j *jsiiProxy_DataGoogleBigtableTableIamPolicy) TableInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tableInput",
...
func (j *jsiiProxy_DataGoogleBigtableTableIamPolicy) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.24.0/docs/data-sources/google_bigtable_table_iam_policy google_bigtable_table_iam_policy} Data Source.
func NewDataGoogleBigtableTableIamPolicy(scope constructs.Construct, id *string, config *DataGoogleBigtableTableIamPolicyConfig) DataGoogleBigtableTableIamPolicy {
	...
	if err := validateNewDataGoogleBigtableTableIamPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataGoogleBigtableTableIamPolicy_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google-beta.dataGoogleBigtableTableIamPolicy.DataGoogleBigtableTableIamPolicy",
...
func (d *jsiiProxy_DataGoogleBigtableTableIamPolicy) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleBigtableTableIamPolicy) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleBigtableTableIamPolicy) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleBigtableTableIamPolicy) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleBigtableTableIamPolicy) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleBigtableTableIamPolicy) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleBigtableTableIamPolicy) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleBigtableTableIamPolicy) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleBigtableTableIamPolicy) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleBigtableTableIamPolicy) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleBigtableTableIamPolicy) ResetProject() {
	_jsii_.InvokeVoid(
		d,
		"resetProject",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleBigtableTableIamPolicy) ToString() *string {
	var returns *string
