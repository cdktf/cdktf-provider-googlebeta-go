...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSecretAccessKeyWo", GoMethod: "ResetSecretAccessKeyWo"},
			_jsii_.MemberMethod{JsiiMethod: "resetSecretAccessKeyWoVersion", GoMethod: "ResetSecretAccessKeyWoVersion"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			...
			_jsii_.MemberProperty{JsiiProperty: "secretAccessKeyWo", GoGetter: "SecretAccessKeyWo"},
			_jsii_.MemberProperty{JsiiProperty: "secretAccessKeyWoInput", GoGetter: "SecretAccessKeyWoInput"},
			_jsii_.MemberProperty{JsiiProperty: "secretAccessKeyWoVersion", GoGetter: "SecretAccessKeyWoVersion"},
			_jsii_.MemberProperty{JsiiProperty: "secretAccessKeyWoVersionInput", GoGetter: "SecretAccessKeyWoVersionInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
