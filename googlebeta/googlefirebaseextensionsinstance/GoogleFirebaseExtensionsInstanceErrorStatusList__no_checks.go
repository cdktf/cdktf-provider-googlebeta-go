...
func (g *jsiiProxy_GoogleFirebaseExtensionsInstanceErrorStatusList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (g *jsiiProxy_GoogleFirebaseExtensionsInstanceErrorStatusList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_GoogleFirebaseExtensionsInstanceErrorStatusList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_GoogleFirebaseExtensionsInstanceErrorStatusList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
