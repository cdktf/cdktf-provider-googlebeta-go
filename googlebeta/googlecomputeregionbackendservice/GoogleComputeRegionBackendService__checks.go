...
func (g *jsiiProxy_GoogleComputeRegionBackendService) validateMoveToIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (g *jsiiProxy_GoogleComputeRegionBackendService) validatePutCustomMetricsParameters(value interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*GoogleComputeRegionBackendServiceCustomMetrics:
		value := value.(*[]*GoogleComputeRegionBackendServiceCustomMetrics)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*GoogleComputeRegionBackendServiceCustomMetrics:
		value_ := value.([]*GoogleComputeRegionBackendServiceCustomMetrics)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*GoogleComputeRegionBackendServiceCustomMetrics; received %#v (a %T)", value, value)
		}
	}
