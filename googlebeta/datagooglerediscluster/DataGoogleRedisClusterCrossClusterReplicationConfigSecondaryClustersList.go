...
func (j *jsiiProxy_DataGoogleRedisClusterCrossClusterReplicationConfigSecondaryClustersList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleRedisClusterCrossClusterReplicationConfigSecondaryClustersList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleRedisClusterCrossClusterReplicationConfigSecondaryClustersList {
	_init_.Initialize()
...
func NewDataGoogleRedisClusterCrossClusterReplicationConfigSecondaryClustersList_Override(d DataGoogleRedisClusterCrossClusterReplicationConfigSecondaryClustersList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleRedisClusterCrossClusterReplicationConfigSecondaryClustersList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleRedisClusterCrossClusterReplicationConfigSecondaryClustersList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleRedisClusterCrossClusterReplicationConfigSecondaryClustersList) Resolve(_context cdktf.IResolveContext) interface{} {
