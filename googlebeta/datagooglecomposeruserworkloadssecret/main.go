...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataGoogleComposerUserWorkloadsSecret)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google-beta.dataGoogleComposerUserWorkloadsSecret.DataGoogleComposerUserWorkloadsSecretConfig",
		reflect.TypeOf((*DataGoogleComposerUserWorkloadsSecretConfig)(nil)).Elem(),
	)
}
