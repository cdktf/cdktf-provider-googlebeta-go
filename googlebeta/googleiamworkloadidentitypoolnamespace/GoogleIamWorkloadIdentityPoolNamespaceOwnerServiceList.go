...
func (j *jsiiProxy_GoogleIamWorkloadIdentityPoolNamespaceOwnerServiceList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleIamWorkloadIdentityPoolNamespaceOwnerServiceList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleIamWorkloadIdentityPoolNamespaceOwnerServiceList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktf/provider-google-beta.googleIamWorkloadIdentityPoolNamespace.GoogleIamWorkloadIdentityPoolNamespaceOwnerServiceList",
...
func NewGoogleIamWorkloadIdentityPoolNamespaceOwnerServiceList_Override(g GoogleIamWorkloadIdentityPoolNamespaceOwnerServiceList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleIamWorkloadIdentityPoolNamespaceOwnerServiceList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleIamWorkloadIdentityPoolNamespaceOwnerServiceList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleIamWorkloadIdentityPoolNamespaceOwnerServiceList) Resolve(_context cdktf.IResolveContext) interface{} {
