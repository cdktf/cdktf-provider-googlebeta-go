...
func (g *jsiiProxy_GoogleTranscoderJobTemplateConfigAOutputReference) validatePutAdBreaksParameters(value interface{}) error {
	...
	case []*GoogleTranscoderJobTemplateConfigAdBreaks:
		value_ := value.([]*GoogleTranscoderJobTemplateConfigAdBreaks)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
...
func (g *jsiiProxy_GoogleTranscoderJobTemplateConfigAOutputReference) validatePutEditListParameters(value interface{}) error {
	...
	case []*GoogleTranscoderJobTemplateConfigEditListStruct:
		value_ := value.([]*GoogleTranscoderJobTemplateConfigEditListStruct)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
...
func (g *jsiiProxy_GoogleTranscoderJobTemplateConfigAOutputReference) validatePutElementaryStreamsParameters(value interface{}) error {
	...
	case []*GoogleTranscoderJobTemplateConfigElementaryStreams:
		value_ := value.([]*GoogleTranscoderJobTemplateConfigElementaryStreams)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
...
func (g *jsiiProxy_GoogleTranscoderJobTemplateConfigAOutputReference) validatePutEncryptionsParameters(value interface{}) error {
	...
	case []*GoogleTranscoderJobTemplateConfigEncryptions:
		value_ := value.([]*GoogleTranscoderJobTemplateConfigEncryptions)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
...
func (g *jsiiProxy_GoogleTranscoderJobTemplateConfigAOutputReference) validatePutInputsParameters(value interface{}) error {
	...
	case []*GoogleTranscoderJobTemplateConfigInputs:
		value_ := value.([]*GoogleTranscoderJobTemplateConfigInputs)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
...
func (g *jsiiProxy_GoogleTranscoderJobTemplateConfigAOutputReference) validatePutManifestsParameters(value interface{}) error {
	...
	case []*GoogleTranscoderJobTemplateConfigManifests:
		value_ := value.([]*GoogleTranscoderJobTemplateConfigManifests)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
...
func (g *jsiiProxy_GoogleTranscoderJobTemplateConfigAOutputReference) validatePutMuxStreamsParameters(value interface{}) error {
	...
	case []*GoogleTranscoderJobTemplateConfigMuxStreams:
		value_ := value.([]*GoogleTranscoderJobTemplateConfigMuxStreams)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
...
func (g *jsiiProxy_GoogleTranscoderJobTemplateConfigAOutputReference) validatePutOverlaysParameters(value interface{}) error {
	...
	case []*GoogleTranscoderJobTemplateConfigOverlays:
		value_ := value.([]*GoogleTranscoderJobTemplateConfigOverlays)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
