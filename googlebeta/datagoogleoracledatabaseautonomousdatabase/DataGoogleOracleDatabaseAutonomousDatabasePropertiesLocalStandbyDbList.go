...
func (j *jsiiProxy_DataGoogleOracleDatabaseAutonomousDatabasePropertiesLocalStandbyDbList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleOracleDatabaseAutonomousDatabasePropertiesLocalStandbyDbList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleOracleDatabaseAutonomousDatabasePropertiesLocalStandbyDbList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktf/provider-google-beta.dataGoogleOracleDatabaseAutonomousDatabase.DataGoogleOracleDatabaseAutonomousDatabasePropertiesLocalStandbyDbList",
...
func NewDataGoogleOracleDatabaseAutonomousDatabasePropertiesLocalStandbyDbList_Override(d DataGoogleOracleDatabaseAutonomousDatabasePropertiesLocalStandbyDbList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleOracleDatabaseAutonomousDatabasePropertiesLocalStandbyDbList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleOracleDatabaseAutonomousDatabasePropertiesLocalStandbyDbList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleOracleDatabaseAutonomousDatabasePropertiesLocalStandbyDbList) Resolve(_context cdktf.IResolveContext) interface{} {
