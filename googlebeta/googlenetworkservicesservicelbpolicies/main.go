...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "autoCapacityDrain", GoGetter: "AutoCapacityDrain"},
			_jsii_.MemberProperty{JsiiProperty: "autoCapacityDrainInput", GoGetter: "AutoCapacityDrainInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putAutoCapacityDrain", GoMethod: "PutAutoCapacityDrain"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "failoverHealthThreshold", GoGetter: "FailoverHealthThreshold"},
			_jsii_.MemberProperty{JsiiProperty: "failoverHealthThresholdInput", GoGetter: "FailoverHealthThresholdInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
