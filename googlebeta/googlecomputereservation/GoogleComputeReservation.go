...
import (
	...
	"github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googlecomputereservation/internal"
...
func (j *jsiiProxy_GoogleComputeReservation) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_GoogleComputeReservation)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
