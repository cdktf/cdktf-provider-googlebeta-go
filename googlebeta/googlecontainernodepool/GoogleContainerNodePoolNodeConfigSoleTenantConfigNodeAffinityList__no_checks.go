...
func (j *jsiiProxy_GoogleContainerNodePoolNodeConfigSoleTenantConfigNodeAffinityList) validateSetInternalValueParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_GoogleContainerNodePoolNodeConfigSoleTenantConfigNodeAffinityList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_GoogleContainerNodePoolNodeConfigSoleTenantConfigNodeAffinityList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
