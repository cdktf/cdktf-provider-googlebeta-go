...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.11.2/docs/resources/google_identity_platform_config google_identity_platform_config}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.11.2/docs/resources/google_identity_platform_config google_identity_platform_config} Resource.
...
func GoogleIdentityPlatformConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateGoogleIdentityPlatformConfig_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleIdentityPlatformConfig) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleIdentityPlatformConfig) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleIdentityPlatformConfig) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleIdentityPlatformConfig) MoveToId(id *string) {
