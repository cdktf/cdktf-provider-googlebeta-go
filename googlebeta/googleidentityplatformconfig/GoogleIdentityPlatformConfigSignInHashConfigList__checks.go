...
func (g *jsiiProxy_GoogleIdentityPlatformConfigSignInHashConfigList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (g *jsiiProxy_GoogleIdentityPlatformConfigSignInHashConfigList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_GoogleIdentityPlatformConfigSignInHashConfigList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_GoogleIdentityPlatformConfigSignInHashConfigList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
