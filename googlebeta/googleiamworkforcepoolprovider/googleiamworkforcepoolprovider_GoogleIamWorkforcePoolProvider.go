...
import (
	...
	"github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v4/googleiamworkforcepoolprovider/internal"
...
func (j *jsiiProxy_GoogleIamWorkforcePoolProvider) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://www.terraform.io/docs/providers/google-beta/r/google_iam_workforce_pool_provider google_iam_workforce_pool_provider} Resource.
...
func (j *jsiiProxy_GoogleIamWorkforcePoolProvider)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
