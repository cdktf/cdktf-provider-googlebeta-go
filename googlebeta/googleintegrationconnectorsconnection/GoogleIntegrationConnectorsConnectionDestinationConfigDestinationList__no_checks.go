...
func (g *jsiiProxy_GoogleIntegrationConnectorsConnectionDestinationConfigDestinationList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_GoogleIntegrationConnectorsConnectionDestinationConfigDestinationList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_GoogleIntegrationConnectorsConnectionDestinationConfigDestinationList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
