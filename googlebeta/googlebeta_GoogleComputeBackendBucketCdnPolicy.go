...
type GoogleComputeBackendBucketCdnPolicy struct {
	...
	CacheKeyPolicy *GoogleComputeBackendBucketCdnPolicyCacheKeyPolicy `field:"optional" json:"cacheKeyPolicy" yaml:"cacheKeyPolicy"`
