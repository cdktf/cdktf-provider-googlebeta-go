...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRetainedReleaseCount", GoMethod: "ResetRetainedReleaseCount"},
			...
			_jsii_.MemberProperty{JsiiProperty: "retainedReleaseCountInput", GoGetter: "RetainedReleaseCountInput"},
