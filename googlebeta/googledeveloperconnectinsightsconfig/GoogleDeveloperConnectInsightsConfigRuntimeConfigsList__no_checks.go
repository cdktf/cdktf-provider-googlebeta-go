...
func (g *jsiiProxy_GoogleDeveloperConnectInsightsConfigRuntimeConfigsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (g *jsiiProxy_GoogleDeveloperConnectInsightsConfigRuntimeConfigsList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_GoogleDeveloperConnectInsightsConfigRuntimeConfigsList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_GoogleDeveloperConnectInsightsConfigRuntimeConfigsList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
