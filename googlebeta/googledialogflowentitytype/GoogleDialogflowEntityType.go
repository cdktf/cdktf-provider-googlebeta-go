...
import (
	...
	"github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googledialogflowentitytype/internal"
...
func (j *jsiiProxy_GoogleDialogflowEntityType) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_GoogleDialogflowEntityType)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
