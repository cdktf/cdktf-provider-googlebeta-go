...
type GoogleCloudRunV2JobTemplateTemplateContainersStartupProbeOutputReference interface {
	...
	// Experimental.
	Fqn() *string
	Grpc() GoogleCloudRunV2JobTemplateTemplateContainersStartupProbeGrpcOutputReference
	GrpcInput() *GoogleCloudRunV2JobTemplateTemplateContainersStartupProbeGrpc
	...
	PutGrpc(value *GoogleCloudRunV2JobTemplateTemplateContainersStartupProbeGrpc)
...
func (j *jsiiProxy_GoogleCloudRunV2JobTemplateTemplateContainersStartupProbeOutputReference) Grpc() GoogleCloudRunV2JobTemplateTemplateContainersStartupProbeGrpcOutputReference {
	var returns GoogleCloudRunV2JobTemplateTemplateContainersStartupProbeGrpcOutputReference
	_jsii_.Get(
		j,
		"grpc",
		&returns,
...
func (j *jsiiProxy_GoogleCloudRunV2JobTemplateTemplateContainersStartupProbeOutputReference) GrpcInput() *GoogleCloudRunV2JobTemplateTemplateContainersStartupProbeGrpc {
...
func (g *jsiiProxy_GoogleCloudRunV2JobTemplateTemplateContainersStartupProbeOutputReference) PutGrpc(value *GoogleCloudRunV2JobTemplateTemplateContainersStartupProbeGrpc) {
...
func (g *jsiiProxy_GoogleCloudRunV2JobTemplateTemplateContainersStartupProbeOutputReference) ResetGrpc() {
	_jsii_.InvokeVoid(
		g,
		"resetGrpc",
		nil, // no parameters
