...
type GoogleComputeRegionNetworkFirewallPolicyRuleConfig struct {
	...
	Match *GoogleComputeRegionNetworkFirewallPolicyRuleMatch `field:"required" json:"match" yaml:"match"`
	...
	Timeouts *GoogleComputeRegionNetworkFirewallPolicyRuleTimeouts `field:"optional" json:"timeouts" yaml:"timeouts"`
}
