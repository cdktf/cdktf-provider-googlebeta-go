...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "nodeScalingFactor", GoGetter: "NodeScalingFactor"},
			_jsii_.MemberProperty{JsiiProperty: "nodeScalingFactorInput", GoGetter: "NodeScalingFactorInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetNodeScalingFactor", GoMethod: "ResetNodeScalingFactor"},
