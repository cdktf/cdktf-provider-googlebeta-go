...
func (j *jsiiProxy_GoogleBigtableInstance) EffectiveLabels() cdktf.StringMap {
...
func (j *jsiiProxy_GoogleBigtableInstance) TerraformLabels() cdktf.StringMap {
	var returns cdktf.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.40.0/docs/resources/google_bigtable_instance google_bigtable_instance} Resource.
...
func GoogleBigtableInstance_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleBigtableInstance_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleBigtableInstance) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleBigtableInstance) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleBigtableInstance) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleBigtableInstance) MoveToId(id *string) {
