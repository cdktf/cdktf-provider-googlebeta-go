...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.41.0/docs/resources/google_network_security_security_profile google_network_security_security_profile}.
...
func (j *jsiiProxy_GoogleNetworkSecuritySecurityProfile) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_GoogleNetworkSecuritySecurityProfile) EffectiveLabels() cdktf.StringMap {
...
func (j *jsiiProxy_GoogleNetworkSecuritySecurityProfile) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_GoogleNetworkSecuritySecurityProfile) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleNetworkSecuritySecurityProfile) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_GoogleNetworkSecuritySecurityProfile) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GoogleNetworkSecuritySecurityProfile) TerraformLabels() cdktf.StringMap {
	var returns cdktf.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.41.0/docs/resources/google_network_security_security_profile google_network_security_security_profile} Resource.
...
func GoogleNetworkSecuritySecurityProfile_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleNetworkSecuritySecurityProfile) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleNetworkSecuritySecurityProfile) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleNetworkSecuritySecurityProfile) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
