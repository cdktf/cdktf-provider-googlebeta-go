...
func (j *jsiiProxy_GoogleGkeonpremVmwareClusterFleetList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GoogleGkeonpremVmwareClusterFleetList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_GoogleGkeonpremVmwareClusterFleetList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (g *jsiiProxy_GoogleGkeonpremVmwareClusterFleetList) ComputeFqn() *string {
	var returns *string
...
func (g *jsiiProxy_GoogleGkeonpremVmwareClusterFleetList) Get(index *float64) GoogleGkeonpremVmwareClusterFleetOutputReference {
	if err := g.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns GoogleGkeonpremVmwareClusterFleetOutputReference
...
func (g *jsiiProxy_GoogleGkeonpremVmwareClusterFleetList) ToString() *string {
	var returns *string
