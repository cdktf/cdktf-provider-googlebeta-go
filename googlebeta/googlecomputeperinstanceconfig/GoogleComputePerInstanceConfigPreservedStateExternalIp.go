...
type GoogleComputePerInstanceConfigPreservedStateExternalIp struct {
	...
	IpAddress *GoogleComputePerInstanceConfigPreservedStateExternalIpIpAddress `field:"optional" json:"ipAddress" yaml:"ipAddress"`
}
