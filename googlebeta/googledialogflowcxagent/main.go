...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "deleteChatEngineOnDestroy", GoGetter: "DeleteChatEngineOnDestroy"},
			_jsii_.MemberProperty{JsiiProperty: "deleteChatEngineOnDestroyInput", GoGetter: "DeleteChatEngineOnDestroyInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDeleteChatEngineOnDestroy", GoMethod: "ResetDeleteChatEngineOnDestroy"},
