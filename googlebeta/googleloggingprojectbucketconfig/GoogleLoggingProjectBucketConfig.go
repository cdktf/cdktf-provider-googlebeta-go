...
import (
	...
	"github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6/googleloggingprojectbucketconfig/internal"
...
func (j *jsiiProxy_GoogleLoggingProjectBucketConfig) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_GoogleLoggingProjectBucketConfig)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
