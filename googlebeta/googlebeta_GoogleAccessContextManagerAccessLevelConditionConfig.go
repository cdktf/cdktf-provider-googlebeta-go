...
type GoogleAccessContextManagerAccessLevelConditionConfig struct {
	// Experimental.
	...
	DevicePolicy *GoogleAccessContextManagerAccessLevelConditionDevicePolicy `field:"optional" json:"devicePolicy" yaml:"devicePolicy"`
	...
	Timeouts *GoogleAccessContextManagerAccessLevelConditionTimeouts `field:"optional" json:"timeouts" yaml:"timeouts"`
}
