...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetThirdPartyProvider", GoMethod: "ResetThirdPartyProvider"},
			...
			_jsii_.MemberProperty{JsiiProperty: "thirdPartyProvider", GoGetter: "ThirdPartyProvider"},
			_jsii_.MemberProperty{JsiiProperty: "thirdPartyProviderInput", GoGetter: "ThirdPartyProviderInput"},
