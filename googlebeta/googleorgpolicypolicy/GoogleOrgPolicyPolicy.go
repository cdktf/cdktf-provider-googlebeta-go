...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.38.0/docs/resources/google_org_policy_policy google_org_policy_policy}.
...
type jsiiProxy_GoogleOrgPolicyPolicy struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_GoogleOrgPolicyPolicy) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_GoogleOrgPolicyPolicy) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_GoogleOrgPolicyPolicy) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_GoogleOrgPolicyPolicy) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GoogleOrgPolicyPolicy) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_GoogleOrgPolicyPolicy) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_GoogleOrgPolicyPolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_GoogleOrgPolicyPolicy) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleOrgPolicyPolicy) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_GoogleOrgPolicyPolicy) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_GoogleOrgPolicyPolicy) Node() constructs.Node {
...
func (j *jsiiProxy_GoogleOrgPolicyPolicy) Parent() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parent",
...
func (j *jsiiProxy_GoogleOrgPolicyPolicy) ParentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parentInput",
...
func (j *jsiiProxy_GoogleOrgPolicyPolicy) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_GoogleOrgPolicyPolicy) Spec() GoogleOrgPolicyPolicySpecOutputReference {
	var returns GoogleOrgPolicyPolicySpecOutputReference
	_jsii_.Get(
		j,
		"spec",
		&returns,
...
func (j *jsiiProxy_GoogleOrgPolicyPolicy) SpecInput() *GoogleOrgPolicyPolicySpec {
...
func (j *jsiiProxy_GoogleOrgPolicyPolicy) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GoogleOrgPolicyPolicy) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleOrgPolicyPolicy) Timeouts() GoogleOrgPolicyPolicyTimeoutsOutputReference {
	var returns GoogleOrgPolicyPolicyTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.38.0/docs/resources/google_org_policy_policy google_org_policy_policy} Resource.
func NewGoogleOrgPolicyPolicy(scope constructs.Construct, id *string, config *GoogleOrgPolicyPolicyConfig) GoogleOrgPolicyPolicy {
	...
	if err := validateNewGoogleOrgPolicyPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func GoogleOrgPolicyPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleOrgPolicyPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleOrgPolicyPolicy) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleOrgPolicyPolicy) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleOrgPolicyPolicy) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (g *jsiiProxy_GoogleOrgPolicyPolicy) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (g *jsiiProxy_GoogleOrgPolicyPolicy) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (g *jsiiProxy_GoogleOrgPolicyPolicy) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (g *jsiiProxy_GoogleOrgPolicyPolicy) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (g *jsiiProxy_GoogleOrgPolicyPolicy) GetStringAttribute(terraformAttribute *string) *string {
...
func (g *jsiiProxy_GoogleOrgPolicyPolicy) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (g *jsiiProxy_GoogleOrgPolicyPolicy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleOrgPolicyPolicy) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleOrgPolicyPolicy) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleOrgPolicyPolicy) MoveToId(id *string) {
...
func (g *jsiiProxy_GoogleOrgPolicyPolicy) OverrideLogicalId(newLogicalId *string) {
...
func (g *jsiiProxy_GoogleOrgPolicyPolicy) PutTimeouts(value *GoogleOrgPolicyPolicyTimeouts) {
...
func (g *jsiiProxy_GoogleOrgPolicyPolicy) ResetId() {
	_jsii_.InvokeVoid(
		g,
		"resetId",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleOrgPolicyPolicy) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		g,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleOrgPolicyPolicy) ResetSpec() {
	_jsii_.InvokeVoid(
		g,
		"resetSpec",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleOrgPolicyPolicy) ResetTimeouts() {
	_jsii_.InvokeVoid(
		g,
		"resetTimeouts",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleOrgPolicyPolicy) ToString() *string {
	var returns *string
