...
type GoogleMonitoringSloBasicSliLatency struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/4.63.1/docs/resources/google_monitoring_slo#threshold GoogleMonitoringSlo#threshold}
